...
const tenantService = new tenant_provisioning_service_1.TenantProvisioningService();
router.use(response_1.responseMiddleware);
router.post('/', security_middleware_1.authRateLimit, auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
    const tenantRequest = req.body;
    logger_1.logger.info('Tenant creation request received', {
...
router.get('/', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
...
router.get('/:tenantId', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
...
router.put('/:tenantId', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
    const { tenantId } = req.params;
    ...
    logger_1.logger.info('Tenant updated', {
        tenantId,
...
router.delete('/:tenantId', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
    const { tenantId } = req.params;
...
router.post('/:tenantId/reactivate', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
    const { tenantId } = req.params;
    ...
    logger_1.logger.info('Tenant reactivated', {
        tenantId,
...
router.get('/:tenantId/health', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)('super_admin'), (0, error_middleware_1.asyncHandler)(async (req, res) => {
    const { tenantId } = req.params;
    const status = await tenantService.getTenantStatus(tenantId);
    const healthChecks = {
