...
export type ProductivityMetricType = 'commands_per_hour' | 'error_rate' | 'session_duration' | 'productivity_score' | 'code_quality_score' | 'response_time' | 'task_completion_time' | 'agent_usage_frequency';
